package com.chefshub.data.cache

import PrefKeys
import android.content.Context
import android.content.SharedPreferences
import com.chefshub.data.R
...
class PreferencesGateway @Inject constructor(@ApplicationContext val context: Context) {
    ...
    inline fun getLangCode(): String {
        return context
            .getSharedPreferences(PREFERENCES_NAME, Context.MODE_PRIVATE)
            .getString(PrefKeys.LANG, null) ?: context.getString(R.string.lang_code)
